import{p as B}from"./chunk-4BMEZGHF.Uk8EinRB.js";import{_ as i,s as F,g as P,q as S,p as W,a as z,b as T,D as x,H as D,e as v,y as E,E as A,F as H,l as $}from"../app.CVzzZfDj.js";import{p as R}from"./radar-MK3ICKWK.DsulwHXA.js";import"./framework.BTHFNYH-.js";import"./isIterateeCall.DmV5WHBc.js";import"./theme.GtFjoDy6.js";import"./baseUniq.C3QhOezH.js";import"./isSymbol.DYPLY1nq.js";import"./basePickBy.C3sJQPRV.js";import"./toFinite.CaWsV0a4.js";import"./clone.CfLH4KiQ.js";var w={packet:[]},u=structuredClone(w),Y=H.packet,L=i(()=>{const t=x({...Y,...A().packet});return t.showBits&&(t.paddingY+=10),t},"getConfig"),q=i(()=>u.packet,"getPacket"),I=i(t=>{t.length>0&&u.packet.push(t)},"pushWord"),M=i(()=>{E(),u=structuredClone(w)},"clear"),m={pushWord:I,getPacket:q,getConfig:L,clear:M,setAccTitle:T,getAccTitle:z,setDiagramTitle:W,getDiagramTitle:S,getAccDescription:P,setAccDescription:F},N=1e4,X=i(t=>{B(t,m);let e=-1,o=[],s=1;const{bitsPerRow:n}=m.getConfig();for(let{start:a,end:r,label:p}of t.blocks){if(r&&r<a)throw new Error(`Packet block ${a} - ${r} is invalid. End must be greater than start.`);if(a!==e+1)throw new Error(`Packet block ${a} - ${r??a} is not contiguous. It should start from ${e+1}.`);for(e=r??a,$.debug(`Packet block ${a} - ${e} with label ${p}`);o.length<=n+1&&m.getPacket().length<N;){const[h,c]=_({start:a,end:r,label:p},s,n);if(o.push(h),h.end+1===s*n&&(m.pushWord(o),o=[],s++),!c)break;({start:a,end:r,label:p}=c)}}m.pushWord(o)},"populate"),_=i((t,e,o)=>{if(t.end===void 0&&(t.end=t.start),t.start>t.end)throw new Error(`Block start ${t.start} is greater than block end ${t.end}.`);return t.end+1<=e*o?[t,void 0]:[{start:t.start,end:e*o-1,label:t.label},{start:e*o,end:t.end,label:t.label}]},"getNextFittingBlock"),j={parse:i(async t=>{const e=await R("packet",t);$.debug(e),X(e)},"parse")},G=i((t,e,o,s)=>{const n=s.db,a=n.getConfig(),{rowHeight:r,paddingY:p,bitWidth:h,bitsPerRow:c}=a,f=n.getPacket(),l=n.getDiagramTitle(),k=r+p,d=k*(f.length+1)-(l?0:r),b=h*c+2,g=D(e);g.attr("viewbox",`0 0 ${b} ${d}`),v(g,d,b,a.useMaxWidth);for(const[y,C]of f.entries())J(g,C,y,a);g.append("text").text(l).attr("x",b/2).attr("y",d-k/2).attr("dominant-baseline","middle").attr("text-anchor","middle").attr("class","packetTitle")},"draw"),J=i((t,e,o,{rowHeight:s,paddingX:n,paddingY:a,bitWidth:r,bitsPerRow:p,showBits:h})=>{const c=t.append("g"),f=o*(s+a)+a;for(const l of e){const k=l.start%p*r+1,d=(l.end-l.start+1)*r-n;if(c.append("rect").attr("x",k).attr("y",f).attr("width",d).attr("height",s).attr("class","packetBlock"),c.append("text").attr("x",k+d/2).attr("y",f+s/2).attr("class","packetLabel").attr("dominant-baseline","middle").attr("text-anchor","middle").text(l.label),!h)continue;const b=l.end===l.start,g=f-2;c.append("text").attr("x",k+(b?d/2:0)).attr("y",g).attr("class","packetByte start").attr("dominant-baseline","auto").attr("text-anchor",b?"middle":"start").text(l.start),b||c.append("text").attr("x",k+d).attr("y",g).attr("class","packetByte end").attr("dominant-baseline","auto").attr("text-anchor","end").text(l.end)}},"drawWord"),K={draw:G},O={byteFontSize:"10px",startByteColor:"black",endByteColor:"black",labelColor:"black",labelFontSize:"12px",titleColor:"black",titleFontSize:"14px",blockStrokeColor:"black",blockStrokeWidth:"1",blockFillColor:"#efefef"},U=i(({packet:t}={})=>{const e=x(O,t);return`
	...
	`},"styles"),Q={parser:j,db:m,renderer:K,styles:U};export{Q as diagram};
